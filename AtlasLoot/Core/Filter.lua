...
function AtlasLoot_SetupFilterButton()
	AtlasLootFilterCheck:RegisterForClicks("LeftButtonUp", "RightButtonUp")
	AtlasLootFilterCheck:SetScript("OnClick", function(self, button)
...
local function CreateCheckButton(parrent, text, num)
	...
	Check:SetScript("OnShow", function(self)
		_G[self:GetName().."Text"]:SetText(BabbleInventory[text])
