...
-- T1 Sets
AtlasLoot_TableNames["T1Druid"] = { BabbleEpoch["Cenarion Rainment"], "AtlasLootOriginalWoW" }
AtlasLoot_TableNames["T1Hunter"] = { BabbleEpoch["Giantstalker Armor"], "AtlasLootOriginalWoW" }
AtlasLoot_TableNames["T1Mage"] = { BabbleEpoch["Arcanist Regalia"], "AtlasLootOriginalWoW" }
AtlasLoot_TableNames["T1Paladin"] = { BabbleEpoch["Lawbringer Armor"], "AtlasLootOriginalWoW" }
AtlasLoot_TableNames["T1Priest"] = { BabbleEpoch["Vestments of Prophecy"], "AtlasLootOriginalWoW" }
AtlasLoot_TableNames["T1Rogue"] = { BabbleEpoch["Nightslayer Armor"], "AtlasLootOriginalWoW" }
AtlasLoot_TableNames["T1Shaman"] = { BabbleEpoch["The Earthfury"], "AtlasLootOriginalWoW" }
AtlasLoot_TableNames["T1Warlock"] = { BabbleEpoch["Felheart Raiment"], "AtlasLootOriginalWoW" }
AtlasLoot_TableNames["T1Warrior"] = { BabbleEpoch["Battlegear of Might"], "AtlasLootOriginalWoW" }
-- T2 Sets
...
AtlasLoot_TableNames["SETSCLASSIC"] = { BabbleEpoch["Misc Tier 0 & Tier 0.5"], "Menu" }
...
AtlasLoot_TableNames["T0SET"] = { AL["Tier 0 & Tier 0.5"], "Menu" }
AtlasLoot_TableNames["T1SETMENU"] = { AL["Tier 1"], "Menu" }
